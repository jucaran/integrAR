...
import OptionsScreenTeacher from "../../screens/Options/OptionsScreenTeacher";
...
export default function OptionsStackTeacher() {
  return (
    <Stack.Navigator
      screenOptions={{
        headerStyle: {
    ...
    >
      <Stack.Screen name="Options" component={OptionsScreenTeacher} />
